...
C
	...
	GO TO 20
10	Y1=1.0 $ Y3=1.0 $ MDUM=MMAX $ MDUM1=M1 $ SIGN=1.0
20  ATERM2=0.0
	ATERM3=0.0
	LDUM=LMAX
...
C	CALCULATE Y2
C
	CALL MAP (1,L,MDUM,AL,BE,DE,LD1,AL1,BE1,DE1)
...
220 IF (YCB(L).EQ.0.0) GO TO 230
	...
	IF (ABS(ATERM3).GT.ABS(ATDS)) ATERM3=ATDS
	GO TO 240
230	ATERM3=RO3*V(L,2,N3)*DYR*BE
C
...
350	CONTINUE
	...
	RETURN
C
360	FORMAT (1H0,61H***** A NEGATIVE SQUARE ROOT OCCURED IN SUBROUTINE
